    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <form id="form2" role="form" novalidate enctype="multipart/form-data" autocomplete="off">

                    <!-- Header -->
                    <div class="text-center" style="margin-bottom:15px;">
                        <h4 class="text-uppercase"><b>Property transaction for movable property</b></h4>
                        <small>(Prior intimation / Seeking sanction under Rule 18 (3) of the CCS (Conduct) Rules, 1964)</small>
                    </div>

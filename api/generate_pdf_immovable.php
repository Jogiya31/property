...
try {
    ...
    ");
        ...
        $lastAction = 'PDF Generated';

        $remarks = 'PDF generated by ' . ($_SESSION['username'] ?? 'Admin') . ' successfully';

        $currentUserRole = $form['designation'] ?? 'Admin';
    ...
    ");
        ...
        $stmtHistory->execute([
            ...
            ':action_by' => $_SESSION['uid'] ?? null,

            ':action_by_role' => $_SESSION['username'] ?? 'Admin',
